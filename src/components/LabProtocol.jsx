...
const LabProtocol = () => (
    <section className="section-padding section-light relative overflow-hidden">
        <div className="main-container relative z-10">
            ...
            >
                <span className="section-tag block text-center">Notre méthode</span>
            ...
            >
                {steps.map((step) => (
                    <motion.article key={step.num} variants={item} className="protocol-card flex flex-col gap-8">
                        <div className="flex items-center justify-between">
                            <span className="text-4xl font-black text-black/10 leading-none tabular-nums">
                                {step.num}
                            </span>
                            <div className="w-14 h-14 rounded-xl bg-black flex items-center justify-center text-accent-gold">
                                <step.icon size={24} strokeWidth={1.75} />
                            </div>
                        </div>
                        <h3 className="text-lg font-black uppercase tracking-[0.08em] text-black leading-tight">
                            {step.title}
                        </h3>
                        <p className="text-[15px] text-black/55 leading-[1.85] font-light flex-1">
                            {step.desc}
                        </p>
                    </motion.article>
                ))}
            ...
            >
                <Link
                    to="/expertise"
                    className="inline-flex items-center gap-4 text-black text-xs font-black uppercase tracking-[0.25em] border-2 border-black px-8 py-4 rounded-lg hover:bg-black hover:text-white transition-all duration-300"
                >
