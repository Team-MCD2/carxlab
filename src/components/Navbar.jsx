...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 left-0 right-0 z-[100] transition-all duration-500 h-[var(--header-height)] flex items-center bg-black/90 backdrop-blur-xl border-b border-white/[0.05]" >
